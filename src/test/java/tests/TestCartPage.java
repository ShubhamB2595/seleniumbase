...
public class TestCartPage extends PageFactoryInitializer {
	...
	String CHECKOUT_MESSAGE="Checkout Your Cart";
	String SHOPPINGCART_MESSAGE="My Shopping Cart";
	...
	public void cartPage_002() throws InterruptedException {
	...
	public void click_On_Remove_Btn() throws InterruptedException {
		loginPage().login_ToApplication(USERNAME, PASSWORD);
		cartPage().preCondition_For_CartPage(bookName);
		SoftAssert softAssert = new SoftAssert();
	...
	public void cartPage_004() throws InterruptedException {
		loginPage().login_ToApplication(USERNAME, PASSWORD);
		cartPage().preCondition_For_CartPage(bookName);
		SoftAssert softAssert = new SoftAssert();
	...
	public void cartPage_008() throws InterruptedException {
		loginPage().login_ToApplication(USERNAME, PASSWORD);
		cartPage().preCondition_For_CartPage(bookName);
		SoftAssert softAssert = new SoftAssert();
	...
	public void cartPage_009() throws InterruptedException {
		loginPage().login_ToApplication(USERNAME, PASSWORD);
		cartPage().preCondition_For_CartPage(bookName);
		SoftAssert softAssert = new SoftAssert();
		cartPage().click_Plus_Btn();
		...
		softAssert.assertTrue(cartPage().isDisplayed_Quantity_Box(), "Should Display Quantity Box");
		ExplicitWaiting.waitForSomeTime(1500);
	...
	@Test(description = "cartPage_014_Verify the Product can't move to wishlist if user not login")
	public void cartPage_014() {
		...
		softAssert.assertNotEquals(pageTitle, SHOPPINGCART_MESSAGE ,"Page title does not match after clicking Wishlist button");
		softAssert.assertAll();
	}

	@Test(description = "cartPage_015 Verify the Product will move to wishlist if user login")
	public void cartPage_015() throws InterruptedException {
		loginPage().login_ToApplication(USERNAME, PASSWORD);
		cartPage().preCondition_For_CartPage(bookName);
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertTrue(cartPage().isDisplayed_WishList_Btn(), "Should Display Wishlist");
		...
		softAssert.assertEquals(pageTitle, CHECKOUT_MESSAGE ,"Page title does not match after clicking Wishlist button");
	...
	public void cartPage_16() throws InterruptedException {
		cartPage().preCondition_For_CartPage(bookName);
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertTrue(cartPage().isDisplayed_Buy_Btn(), "Should Display Buy Button");
		...
		softAssert.assertNotEquals(checkOutPageTitle, CHECKOUT_MESSAGE,"User don't able to buy Product");
		softAssert.assertAll();
	}

	@Test(description = "cartPage_017 Verify user can buy Product if user login")
	public void cartPage_17() throws InterruptedException {
		loginPage().login_ToApplication(USERNAME, PASSWORD);
		cartPage().preCondition_For_CartPage(bookName);
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertTrue(cartPage().isDisplayed_Buy_Btn(), "Should Display Buy Button");
		...
		Thread.sleep(3000);
		String checkOutPageTitle=cartPage().getCheckOutPage_Title();
		softAssert.assertEquals(checkOutPageTitle, CHECKOUT_MESSAGE, "User able to buy Product");
		softAssert.assertAll();
	}
	...
	public void cartPage_021() throws InterruptedException {
		loginPage().login_ToApplication(USERNAME, PASSWORD);
		SoftAssert softAssert = new SoftAssert();
		...
		softAssert.assertTrue(cartPage().isDisplayed_FictionActOfGod_Book(), "Should Display Bihar Dairies");
		Thread.sleep(5000);		
		cartPage().click_FictionBiharDairies_Book();
		cartPage().click_On_AddToCart_Btn();
		String SuccessMessage = cartPage().getCartSuccessMessage_Txt();
		softAssert.assertEquals(SuccessMessage, CART_MESSAGE, "Product not added to cart");
		cartPage().remove_BookFromCart();
