...
public class InitMethod {
    ...
    public static String bookName = appConfig.getBookName();
    ...
    public static String ExcelFiles = "./src/test/resources/TestData/ExcelFiles/";
    public static String PropertiesFiles = "./src/test/resources/TestData/PropertiesFiles/";
